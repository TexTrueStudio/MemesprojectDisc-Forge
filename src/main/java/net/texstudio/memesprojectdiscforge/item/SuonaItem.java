...
public class SuonaItem extends MemesprojectdiscforgeModElements.ModElement {
	@ObjectHolder("memesprojectdiscforge:suona")
	public static final Item block = null;
	public SuonaItem(MemesprojectdiscforgeModElements instance) {
		super(instance, 1);
	}
		...
		public Multimap<Attribute, AttributeModifier> getAttributeModifiers(EquipmentSlotType slot) {
			if (slot == EquipmentSlotType.MAINHAND) {
				...
				builder.put(Attributes.ATTACK_DAMAGE,
						new AttributeModifier(ATTACK_DAMAGE_MODIFIER, "Item modifier", (double) 48, AttributeModifier.Operation.ADDITION));
